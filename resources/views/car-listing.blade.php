        ...
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img">
            @if($data->carpic)
                    ...
                    @endphp
                    <img src="{{ route('getImg', ['filename' => $filename]) }}"  style="width: 250px;">
                @endif
            <!-- <img  src="uploads/{{$data->carpic}} " class="img-responsive" alt="Image" /> -->
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            ...
            @if($data->carpic)
                    ...
                    <div class="recent_post_img"> <a href="cardetail/{{$data->id}}">
              <img src="{{ route('getImg', ['filename' => $filename]) }}" alt="image"></a> </div>
